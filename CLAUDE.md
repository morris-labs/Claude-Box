...
- `Dockerfile` changes: keep the uid/gid remapping (`prime` = 1000:1000) in mind — it exists specifically to avoid file-permission mismatches between host and container.
