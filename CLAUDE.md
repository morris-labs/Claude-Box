...
A single-window dashboard: a table of boxes on top (refreshed on a 3s timer), a tab strip of embedded terminals below, toolbar/context-menu actions (New/Open/Close/Remove/Purge…).
